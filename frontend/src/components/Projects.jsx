...
const Projects = () => {
  ...
  return (
    <section className="py-20 w-full relative">
      {/* Background glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[1000px] h-[500px] bg-[#9333ea]/5 rounded-full blur-[100px] pointer-events-none"></div>

      <div className="max-w-[1400px] mx-auto px-6 relative z-10">
        <div className="text-center mb-12">
          <p className="text-[#4f46e5] text-xs font-bold tracking-widest uppercase mb-2">Our Work</p>
